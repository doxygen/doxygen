...
class TranslatorHungarian : public TranslatorAdapter_1_8_15
{
  ...
  public:
    ...
    { DString result="Ezt a dokumentációt a Doxygen készítette ";
      if (!s.empty()) result+=DString(" a") + zed(s[0])+s+" projekthez";
    ...
    {
      return DString("A")+zed(clName[0])+clName+" osztály származási diagramja:";
    }
...
//////////////////////////////////////////////////////////////////////////
    ...
    { // single is true implies a single file
      DString result="Ez a dokumentáció ";
      switch(compType)
      {
...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return DString("A")+zed(clName[0])+clName+" osztály együttműködési diagramja:";
    }
    /*! this text is put before an include dependency graph */
    DString trInclDepGraph(const DString &fName) override
    {
      return DString("A")+zed(fName[0])+fName+" definíciós fájl függési gráfja:";
    }
...
//////////////////////////////////////////////////////////////////////////
    ...
    { DString result=dirName; result+=" könyvtárreferencia"; return result; }
...
//////////////////////////////////////////////////////////////////////////
    ...
    { return DString("Könyvtár függőségi gráf a(z) ")+name+"-könyvtárhoz:"; }
...
//////////////////////////////////////////////////////////////////////////
    ...
    { DString result = "A dokumentáció ehhez az enum-hoz a következő fájl";
      if (!single) result+="ok";
      result+=" alapján készült:";
      return result;
    }
...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      DString opt = enable ? "engedélyez" : "letilt";
...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      // single is true implies a single file
      DString result="A szolgáltatás dokumentációja "
                                "a következő fájl";
    ...
    {
      // single is true implies a single file
      DString result="Az egyke példány dokomentációja "
                                "a következő fájl";
      if (single) result+="ból"; else result+="okból";
      result+="lett létrehozva:";
      return result;
