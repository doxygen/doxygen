...
Entry::Entry(const Entry &e) : section(e.section)
{
  ...
  callGraphExplicitSet   = e.callGraphExplicitSet;
  callerGraph = e.callerGraph;
  callerGraphExplicitSet = e.callerGraphExplicitSet;
  includeGraph = e.includeGraph;
  includeGraphExplicitSet = e.includeGraphExplicitSet;
  includedByGraph = e.includedByGraph;
  includedByGraphExplicitSet = e.includedByGraphExplicitSet;
  directoryGraph = e.directoryGraph;
  directoryGraphExplicitSet = e.directoryGraphExplicitSet;
  collaborationGraph = e.collaborationGraph;
  collaborationGraphExplicitSet = e.collaborationGraphExplicitSet;
  inheritanceGraph = e.inheritanceGraph;
  inheritanceGraphExplicitSet = e.inheritanceGraphExplicitSet;
  groupGraph  = e.groupGraph;
  groupGraphExplicitSet  = e.groupGraphExplicitSet;
  referencedByRelation = e.referencedByRelation;
  referencedByRelationExplicitSet = e.referencedByRelationExplicitSet;
  referencesRelation   = e.referencesRelation;
  referencesRelationExplicitSet   = e.referencesRelationExplicitSet;
  inlineSource = e.inlineSource;
  inlineSourceExplicitSet = e.inlineSourceExplicitSet;
  exported    = e.exported;
  virt        = e.virt;
  args        = e.args;
...
void Entry::reset()
{
  ...
  bool entryGroupGraphExplicitSet = false;
  //printf("Entry::reset()\n");
  name.clear();
  type.clear();
  args.clear();
  ...
  callGraphExplicitSet   = entryCallGraphExplicitSet;
  callerGraph = entryCallerGraph;
  callerGraphExplicitSet = entryCallerGraphExplicitSet;
  includeGraph = entryIncludeGraph;
  includeGraphExplicitSet = entryIncludeGraphExplicitSet;
  includedByGraph = entryIncludedByGraph;
  includedByGraphExplicitSet = entryIncludedByGraphExplicitSet;
  directoryGraph = entryDirectoryGraph;
  directoryGraphExplicitSet = entryDirectoryGraphExplicitSet;
  collaborationGraph = entryCollaborationGraph;
  collaborationGraphExplicitSet = entryCollaborationGraphExplicitSet;
  ...
  groupGraphExplicitSet = entryGroupGraphExplicitSet;
  referencedByRelation = entryReferencedByRelation;
  referencedByRelationExplicitSet = entryReferencedByRelationExplicitSet;
  referencesRelation   = entryReferencesRelation;
  referencesRelationExplicitSet   = entryReferencesRelationExplicitSet;
  inlineSource = entryInlineSource;
  inlineSourceExplicitSet = entryInlineSourceExplicitSet;
  exported = false;
