...
class TranslatorVietnamese : public TranslatorAdapter_1_6_0
{
  public:
    ...
    { DString result="Được tạo ra bởi Doxygen";
    ...
    {
      DString result="Danh mục đầy đủ tất cả các ";
    ...
    {
      DString result="Danh mục tất cả các ";
      if (!extractAll)
      {
    ...
    {
      DString result="Danh sách tất cả các ";
    ...
    {
      DString result="Được biên soạn vào "+date;
...
//////////////////////////////////////////////////////////////////////////
    ...
    { DString result=dirName; result+=" Tham chiếu thư mục"; return result; }
...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      DString result="Danh sách tất cả ";
      if (!extractAll)
      {
        result+="(đã được mô tả) ";
      }
