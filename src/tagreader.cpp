...
class TagCompoundVariant
{
  public:
    ...
    TagCompoundVariant() {}
    explicit TagCompoundVariant(VariantT &&v) :
...
#define p_warn(fmt, ...) \
  ...
  public:
    explicit TagFileParser(const char *tagName) :
        m_tagName(tagName) {}
...
void parseTagFile(const std::shared_ptr<Entry> &root, const char *fullName)
{
  ...
  parser.parse(
    fullName, inputStr.data(), Debug::isFlagSet(Debug::Lex_xml),
