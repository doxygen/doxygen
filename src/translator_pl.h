...
class TranslatorPolish : public Translator
{
  public:
    ...
    {
      return "Ta strona wyjaśnia jak interpretować wykresy, które są wygenerowane "
             "przez doxygen.<p>\n"
    ...
    {
      QCString result = "Dokumentacja katalogu ";
      result += dirName;
      return result;
    }
    ...
    {
      QCString result = "Dokumentacja wyliczenia ";
      result += name;
      return result;
    }
