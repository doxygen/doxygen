...
class TranslatorFinnish : public TranslatorAdapter_1_6_0
{
  public:
    ...
    { DString result="Automaattisesti luotu Doxygenilla "
    ...
    {
      DString result="Tässä on lista kaikista ";
    ...
    {
      DString result="Tässä on lista kaikista "; // "Here is a list of all "
      if (!extractAll)
      {
...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return DString("Periytyy ")+(numEntries > 1 ? "luokista " : "luokasta ")+trWriteList(numEntries)+"."; // "Inherits "
    }
    ...
    {
      return DString("Periytetään ")+(numEntries > 1 ? "luokissa " : "luokassa ")+trWriteList(numEntries)+"."; // "Inherited by "
    }
    ...
    {
      return DString("Uudelleentoteuttaa ")+(numEntries > 1 ? "luokat " : "luokan  ")+trWriteList(numEntries)+"."; // "Reimplemented from "
    }
    ...
    {
      return DString("Uudelleentoteutetaan ")+(numEntries > 1 ? "luokissa " : "luokassa ")+trWriteList(numEntries)+"."; // "Reimplemented in "
    }
...
//////////////////////////////////////////////////////////////////////////
    ...
    { // here s is one of " Class", " Struct" or " Union"
      ...
      DString result="Dokumentaatio tälle "; // "The documentation for this "
      switch(compType)
      {
...
//////////////////////////////////////////////////////////////////////////
    ...
    { DString result=dirName; result+=" hakemistoreferenssi"; return result; }
        // " Directory Reference"
...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      DString result="Tässä on lista moduulin kaikista "; // "Here is a list of all "
      if (!extractAll) result+="dokumentoiduista"; // "documented "
