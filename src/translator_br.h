...
public:
  ...
  { // here s is one of " Class", " Struct" or " Union"
    ...
    {
    case ClassDef::Class:
      result += vhdlOpt ? "Unidade de Design " : "classe ";
      break;
    case ClassDef::Struct:
      result += "estrutura ";
      break;
  ...
  {
    return "Esta página explica como interpretar os grafos gerados pelo doxygen.<p>\n"
                                               ...
                                               bool single)
  {
    ...
    case ClassDef::Union:
      ...
      break;
    case ClassDef::Interface:
      result += "essa interface ";
      break;
    case ClassDef::Protocol:
      result += "esso protocolo ";
      break;
    case ClassDef::Category:
      result += "essa categoria ";
      break;
    case ClassDef::Exception:
      result += "essa exceção ";
      break;
  ...
  virtual QCString trVhdlType(uint64 type, bool single)
  {
    ...
    case VhdlDocGen::SHAREDVARIABLE:
      if (single)
        ...
        return "Variáveis Compartilhadas";
