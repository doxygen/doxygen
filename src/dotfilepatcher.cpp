...
"<!-- removed from style as the pointer interferes with the URL\n"
".node {cursor: pointer;}\n"
"-->\n"
...
"var elem = document.getElementsByTagName('g');\n"
"if (elem && elem.length) {\n"
"  for (var i=0;i<edges.length;i++) {\n"
"    if (elem[i].id.substr(0,4)=='edge') {\n"
"      elem[i].setAttribute('class','edge');\n"
"      elem[i].setAttribute('class','selected');\n"
"    }\n"
"    else if (edges[i].id.substr(0,4)=='Node') {\n"
"      elem[i].setAttribute('class','node');\n"
"      elem[i].setAttribute('class','selected');\n"
"    }\n"
"  }\n"
"}\n"
...
"\n"
"function main() {\n"
"  let elems = Array.from(document.getElementsByClassName('node'));\n"
"  let links = Array.from(document.getElementsByClassName('edge'));\n"
"\n"
"  let elemsMap = {};\n"
"  let linkedElems = {};\n"
"  let linkedLinks = {};\n"
...
"\n"
"        addItemToMapOfLists(linkedLinks, name1, edge);\n"
"        addItemToMapOfLists(linkedLinks, name2, edge);\n"
"      }\n"
"    }\n"
"  });\n"
"\n"
...
"  }\n"
"\n"
"<!-- interferes with the URL setting\n"
      ...
      if (interactiveSVG_local)
      {
        ...
        else if (insideHeader && !replacedHeader && line.find("<g id=\"graph")!=-1)
        {
          ...
          if (foundSize)
          {
            ...
            t << "<script xlink:href=\"" << relPath << "svgmin.js\"/>\n";
