...
class TranslatorDanish : public TranslatorAdapter_1_8_0
{
  public:
    ...
    { DString result="Automatisk genereret af Doxygen";
    ...
    {
      DString result="Her er en liste over alle ";
...
//////////////////////////////////////////////////////////////////////////
    ...
    { // here s is one of " Class", " Struct" or " Union"
      ...
      DString result="Dokumentationen for denne ";
      switch(compType)
      {
        case ClassDef::Class:      result+="klasse"; break;
        case ClassDef::Struct:     result+="datastruktur"; break;
...
//////////////////////////////////////////////////////////////////////////
    ...
    DString trDirReference(const DString &dirName) override
      { DString result="Indhold af kataloget "; result+=dirName; return result;}
...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      DString result="Her er en liste af alle "; // "Here is a list of all "
      if (!extractAll)
      {
    ...
    {
      DString result="Her er en liste over alle ";     // "Here is a list of all "
    ...
    {
      DString result="Her er en list over alle ";     // "Here is a list of all "
...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return DString("Afhængighedsgraf for katalog ")+name+":";
    }
};
