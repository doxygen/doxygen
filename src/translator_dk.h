...
class TranslatorDanish : public TranslatorAdapter_1_8_0
{
  public:
    ...
    {
      return "Denne side forklarer, hvordan man skal fortolke de grafer, "
    ...
    {
      return "Her er en liste over pakkerne, med korte beskrivelser "
    ...
    QCString trSearchResults(int numDocuments) override
    {
      ...
      {
        return "Fandt <b>$num</b> dokumenter, der passer til din forespørgsel. "
    ...
    {
      QCString result = "Indhold af kataloget ";
      result += dirName;
      return result;
    }
