...
#define MAX_ITEMS_BEFORE_MULTIPAGE_INDEX (int) Config_getInt(MAX_ITEMS_BEFORE_MULTIPAGE_INDEX)
#define MAX_ITEMS_BEFORE_QUICK_INDEX (int) Config_getInt(MAX_ITEMS_BEFORE_QUICK_INDEX)
