...
template <>
struct fmt::formatter<QCString> : formatter<std::string>
{
...
template <>
struct fmt::formatter<Protection> : formatter<std::string>
{
...
template <>
struct fmt::formatter<Specifier> : formatter<std::string>
{
...
template <>
struct fmt::formatter<MethodTypes> : formatter<std::string>
{
...
template <>
struct fmt::formatter<RelatesType> : formatter<std::string>
{
...
template <>
struct fmt::formatter<Relationship> : formatter<std::string>
{
...
template <>
struct fmt::formatter<SrcLangExt> : formatter<std::string>
{
...
template <>
struct fmt::formatter<MemberType> : formatter<std::string>
{
...
template <>
struct fmt::formatter<TypeSpecifier> : formatter<std::string>
{
...
template <>
struct fmt::formatter<EntryType> : formatter<std::string>
{
...
template <>
struct fmt::formatter<MemberListType> : formatter<std::string>
{
