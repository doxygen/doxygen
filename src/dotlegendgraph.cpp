...
void DotLegendGraph::computeTheGraph()
{
  ...
  DotNode{this,9, "Inherited", "", "", TRUE}.writeBox(md5stream, CallGraph, GOF_BITMAP, false);
  md5stream << "  Node10 -> Node9 [dir=\"back\",color=\"steelblue1\",style=\"solid\"];\n";
  DotNode{this,10, "PublicBase", "", "url"}.markHasDocumentation().writeBox(md5stream, CallGraph, GOF_BITMAP, false);
  md5stream << "  Node11 -> Node10 [dir=\"back\",color=\"steelblue1\",style=\"solid\"];\n";
  DotNode{this,11, "Truncated", "", "url"}.markAsTruncated().markHasDocumentation().writeBox(md5stream, CallGraph, GOF_BITMAP, true);
  ...
  DotNode{this,15, "Undocumented", "", ""}.writeBox(md5stream, CallGraph, GOF_BITMAP, false);
