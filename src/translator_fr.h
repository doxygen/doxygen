...
class TranslatorFrench : public TranslatorAdapter_1_9_5
{
  public:
    ...
    {
      return "Cette page explique comment interpréter les graphes générés "
             "par doxygen.<p>\n"
    ...
    {
      QCString result = "Répertoire de référence de ";
      result += dirName;
      return result;
    }
