...
void parseInline();
 ...
 inline bool jj_3R_325()
 {
    ...
    Token * xsp;
    xsp = jj_scanpos;
    if (!jj_3R_415()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_416()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_417()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_418()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_419()) return false;
    jj_scanpos = xsp;
 ...
 inline bool jj_3R_747()
 {
    ...
    Token * xsp;
    xsp = jj_scanpos;
    if (!jj_3R_752()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_753()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_754()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_755()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_756()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_757()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_758()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_759()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_760()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_761()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_762()) return false;
    jj_scanpos = xsp;
    if (!jj_3_115()) return false;
    jj_scanpos = xsp;
 ...
 inline bool jj_3R_585()
 {
    ...
    Token * xsp;
    xsp = jj_scanpos;
    if (!jj_3R_636()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_637()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_638()) return false;
    jj_scanpos = xsp;
    ...
    jj_scanpos = xsp;
    if (!jj_3R_646()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_647()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_648()) return false;
    jj_scanpos = xsp;
 ...
 inline bool jj_3R_626()
 {
    ...
    jj_scanpos = xsp;
    if (!jj_3R_680()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_681()) return false;
    jj_scanpos = xsp;
 ...
 inline bool jj_3R_146()
 {
    ...
    jj_scanpos = xsp;
    if (!jj_3R_311()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_312()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_313()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_314()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_315()) return false;
    jj_scanpos = xsp;
 ...
 inline bool jj_3R_454()
 {
    ...
    Token * xsp;
    xsp = jj_scanpos;
    if (!jj_3R_542()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_543()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_544()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_545()) return false;
    jj_scanpos = xsp;
 ...
 inline bool jj_3R_397()
 {
    ...
    Token * xsp;
    xsp = jj_scanpos;
    if (!jj_3R_482()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_483()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_484()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_485()) return false;
    jj_scanpos = xsp;
 ...
 inline bool jj_3R_466()
 {
    ...
    Token * xsp;
    xsp = jj_scanpos;
    if (!jj_3R_558()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_559()) return false;
    jj_scanpos = xsp;
    if (!jj_3R_560()) return false;
    jj_scanpos = xsp;
