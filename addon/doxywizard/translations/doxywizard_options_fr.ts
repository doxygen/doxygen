...
<message>
        <source>INHERIT_DOCS</source>
            <translation>Si la balise \c INHERIT_DOCS est definie a \c YES, un membre non documente herite de la documentation de tout membre documente qu&#x27;il reimplante.</translation>
    </message>
<message>
        <source>SEPARATE_MEMBER_PAGES</source>
            <translation>Si la balise \c SEPARATE_MEMBER_PAGES est definie a \c YES, Doxygen produira une nouvelle page pour chaque membre. Si defini a \c NO, la documentation d&#x27;un membre fera partie du fichier/classe/namespace qui le contient.</translation>
    </message>
<message>
...
<message>
        <source>ALIASES</source>
            <translation>Cette balise peut etre utilisee pour specifier un certain nombre d&#x27;alias qui agissent comme des commandes dans la documentation. Un alias a la forme: \verbatim name=value\endverbatim Par exemple, ajouter \verbatim &quot;sideeffect=@par Side Effects:^^&quot;\endverbatim vous permettra de mettre la commande \c \sideeffect (ou \c \@sideeffect) dans la documentation, ce qui resultera en un paragraphe defini par l&#x27;utilisateur avec le titre &quot;Side Effects:&quot;. Remarquez que vous ne pouvez pas mettre de \ref cmdn &quot;\n&quot; dans la partie valeur d&#x27;un alias pour inserer des sauts de ligne (dans la sortie resultante). Vous pouvez mettre `^^` dans la partie valeur d&#x27;un alias pour inserer un saut de ligne comme si un saut de ligne physique etait dans le fichier original.</translation>
    </message>
<message>
...
<message>
        <source>OPTIMIZE_FOR_FORTRAN</source>
            <translation>Definissez la balise \c OPTIMIZE_FOR_FORTRAN a \c YES si votre projet contient des sources Fortran. Doxygen generera alors une sortie adaptee au Fortran.</translation>
    </message>
<message>
        <source>OPTIMIZE_OUTPUT_VHDL</source>
            <translation>Definissez la balise \c OPTIMIZE_OUTPUT_VHDL a \c YES si votre projet contient des sources VHDL. Doxygen generera alors une sortie adaptee au VHDL.</translation>
    </message>
<message>
...
<message>
        <source>MARKDOWN_ID_STYLE</source>
            <translation>La balise \c MARKDOWN_ID_STYLE peut etre utilisee pour specifier l&#x27;algorithme utilise pour generer les identifiants pour les titres Markdown. Remarque: Chaque identifiant est unique.</translation>
    </message>
<message>
        <source>AUTOLINK_SUPPORT</source>
            <translation>Lorsqu&#x27;active, Doxygen essaie de lier les mots qui correspondent a des classes documentees ou des namespaces a leur documentation correspondante. Un tel lien peut etre empeche dans des cas individuels en mettant un signe \c % devant le mot ou globalement en definissant \c AUTOLINK_SUPPORT a \c NO. Les mots listes dans la balise \c AUTOLINK_IGNORE_WORDS sont exclus de la liaison automatique.</translation>
    </message>
<message>
        <source>AUTOLINK_IGNORE_WORDS</source>
            <translation>Cette balise specifie une liste de mots qui, lorsqu&#x27;ils correspondent au debut d&#x27;un mot dans la documentation, supprimeront la generation de liens automatiques, si elle est activee via AUTOLINK_SUPPORT. Cette liste n&#x27;affecte pas les liens explicitement crees en utilisant \# ou les commandes \ref cmdlink &quot;\link&quot; ou \ref cmdref &quot;\ref&quot;.</translation>
    </message>
<message>
        <source>BUILTIN_STL_SUPPORT</source>
            <translation>Si vous utilisez des classes STL (c&#x27;est-a-dire `std::string`, `std::vector`, etc.) mais que vous ne voulez pas inclure (un fichier de balises pour) les sources STL comme entree, vous devriez definir cette balise a \c YES afin de laisser Doxygen correspondre aux declarations et definitions de fonctions dont les arguments contiennent des classes STL (par exemple `func(std::string`); contre `func(std::string) {}`). Cela rend egalement les diagrammes d&#x27;heritage et de collaboration qui impliquent des classes STL plus complets et precis.</translation>
    </message>
<message>
...
<message>
        <source>IDL_PROPERTY_SUPPORT</source>
            <translation>Pour l&#x27;IDL de Microsoft, il y a des attributs \c propget et \c propput pour indiquer les methodes getter et setter d&#x27;une propriete. Definir cette option a \c YES fera que Doxygen remplacera les methodes get et set par une propriete dans la documentation. Cela ne fonctionnera que si les methodes obtiennent ou definissent effectivement un type simple. Si ce n&#x27;est pas le cas, ou si vous voulez afficher les methodes quand meme, vous devriez definir cette option a \c NO.</translation>
    </message>
<message>
...
<message>
        <source>GROUP_NESTED_COMPOUNDS</source>
            <translation>Si on ajoute une structure ou une classe a un groupe et que cette option est activee, alors toute classe ou structure imbriquee est egalement ajoutee au meme groupe. Par defaut, cette option est desactivee et on doit ajouter explicitement les composes imbriques via \ref cmdingroup &quot;\ingroup&quot;.</translation>
    </message>
<message>
        <source>SUBGROUPING</source>
            <translation>Definissez la balise \c SUBGROUPING a \c YES pour permettre aux groupes de membres de classe du meme type (par exemple un groupe de fonctions publiques) d&#x27;etre places comme un sous-groupe de ce type (par exemple sous la section Fonctions Publiques). Definissez-la a \c NO pour empecher le sous-groupement. Alternativement, cela peut etre fait par classe en utilisant la commande \ref cmdnosubgrouping &quot;\nosubgrouping&quot;.</translation>
    </message>
<message>
        <source>INLINE_GROUPED_CLASSES</source>
            <translation>Lorsque la balise \c INLINE_GROUPED_CLASSES est definie a \c YES, les classes, structures et unions sont affichees a l&#x27;interieur du groupe dans lequel elles sont incluses (par exemple en utilisant \ref cmdingroup &quot;\ingroup&quot;) au lieu d&#x27;une page separee (pour les pages HTML et Man) ou d&#x27;une section (pour \f$\mbox{\LaTeX}\f$ et RTF). &lt;br&gt;Remarquez que cette fonctionnalite ne fonctionne pas en combinaison avec \ref cfg_separate_member_pages &quot;SEPARATE_MEMBER_PAGES&quot;.</translation>
    </message>
<message>
        <source>INLINE_SIMPLE_STRUCTS</source>
            <translation>Lorsque la balise \c INLINE_SIMPLE_STRUCTS est definie a \c YES, les structures, classes et unions avec uniquement des champs de donnees publiques ou des champs typedef simples seront affichees en ligne dans la documentation de la portee dans laquelle elles sont definies (c&#x27;est-a-dire fichier, namespace ou documentation de groupe), a condition que cette portee soit documentee. Si defini a \c NO, les structures, classes et unions sont affichees sur une page separee (pour les pages HTML et Man) ou section (pour \f$\mbox{\LaTeX}\f$ et RTF).</translation>
    </message>
<message>
        <source>TYPEDEF_HIDES_STRUCT</source>
            <translation>Lorsque la balise \c TYPEDEF_HIDES_STRUCT est activee, un typedef d&#x27;une structure, union ou enumeration est documente comme structure, union ou enumeration avec le nom du typedef. Donc &lt;code&gt;typedef struct TypeS {} TypeT&lt;/code&gt; apparaitra dans la documentation comme une structure avec le nom \c TypeT. Lorsque desactive, le typedef apparaitra comme membre d&#x27;un fichier, namespace ou classe. Et la structure sera nommee \c TypeS. Cela peut typiquement etre utile pour le code C si la convention de codage dicte que tous les types composes sont typedefes et seul le typedef est reference, jamais le nom de balise.</translation>
    </message>
<message>
        <source>LOOKUP_CACHE_SIZE</source>
            <translation>La taille du cache de recherche de symboles peut etre definie en utilisant \c LOOKUP_CACHE_SIZE. Ce cache est utilise pour resoudre les symboles en fonction de leur nom et de leur portee. Comme cela peut etre un processus couteux et souvent le meme symbole apparait plusieurs fois dans le code, Doxygen garde un cache de symboles pre-resolus. Si le cache est trop petit, Doxygen deviendra plus lent. Si le cache est trop grand, la memoire est gaspillee. La taille du cache est donnee par cette formule: \f$2^{(16+\mbox{LOOKUP\_CACHE\_SIZE})}\f$. La plage valide est 0..9, le defaut est 0, correspondant a une taille de cache de \f$2^{16} = 65536\f$ symboles. A la fin d&#x27;une execution, Doxygen rapportera l&#x27;utilisation du cache et suggerera la taille de cache optimale du point de vue de la vitesse.</translation>
    </message>
<message>
        <source>NUM_PROC_THREADS</source>
            <translation>\c NUM_PROC_THREADS specifie le nombre de threads que Doxygen est autorise a utiliser pendant le traitement. Lorsqu&#x27;il est defini a \c 0, Doxygen le basera sur le nombre de coeurs disponibles dans le systeme. Vous pouvez le definir explicitement a une valeur superieure a 0 pour avoir plus de controle sur l&#x27;equilibre entre la charge CPU et la vitesse de traitement. Pour le moment, seul le traitement d&#x27;entree peut etre fait en utilisant plusieurs threads. Comme c&#x27;est encore une fonctionnalite experimentale, le defaut est defini a 1, ce qui desactive effectivement le traitement parallele. Veuillez signaler tout probleme que vous rencontrez. La generation de graphiques dot en parallele est controlee par le parametre \c DOT_NUM_THREADS.</translation>
    </message>
<message>
        <source>TIMESTAMP</source>
            <translation>Si la balise \c TIMESTAMP est definie differemment de \c NO, chaque page generee contiendra la date ou la date et l&#x27;heure ou la page a ete generee. Definir cela a \c NO peut aider lors de la comparaison de la sortie de plusieurs executions.</translation>
    </message>
<message>
...
<message>
        <source>EXTRACT_PRIV_VIRTUAL</source>
            <translation>Si la balise \c EXTRACT_PRIV_VIRTUAL est definie a \c YES, les methodes virtuelles privees documentees d&#x27;une classe seront incluses dans la documentation.</translation>
    </message>
<message>
...
<message>
        <source>INTERNAL_DOCS</source>
            <translation>La balise \c INTERNAL_DOCS determine si la documentation tapee apres une commande \ref cmdinternal &quot;\internal&quot; est incluse. Si la balise est definie a \c NO, la documentation sera exclue. Definissez-la a \c YES pour inclure la documentation interne.</translation>
    </message>
<message>
...
<message>
        <source>HIDE_SCOPE_NAMES</source>
            <translation>Si la balise \c HIDE_SCOPE_NAMES est definie a \c NO, Doxygen montrera les membres avec leurs portees de classe et de namespace completes dans la documentation. Si defini a \c YES, la portee sera cachee.</translation>
    </message>
<message>
        <source>HIDE_COMPOUND_REFERENCE</source>
            <translation>Si la balise \c HIDE_COMPOUND_REFERENCE est definie a \c NO (defaut), Doxygen ajoutera du texte supplementaire au titre d&#x27;une page, tel que Reference de Classe. Si defini a \c YES, la reference de compose sera cachee.</translation>
    </message>
<message>
        <source>SHOW_HEADERFILE</source>
            <translation>Si la balise \c SHOW_HEADERFILE est definie a \c YES, la documentation d&#x27;une classe montrera quel fichier doit etre inclus pour utiliser la classe.</translation>
    </message>
<message>
        <source>SHOW_INCLUDE_FILES</source>
            <translation>Si la balise \c SHOW_INCLUDE_FILES est definie a \c YES, Doxygen mettra une liste des fichiers qui sont inclus par un fichier dans la documentation de ce fichier.</translation>
    </message>
<message>
        <source>SHOW_GROUPED_MEMB_INC</source>
            <translation>Si la balise \c SHOW_GROUPED_MEMB_INC est definie a \c YES, Doxygen ajoutera pour chaque membre groupe une instruction include a la documentation, indiquant au lecteur quel fichier inclure pour utiliser le membre.</translation>
    </message>
<message>
        <source>FORCE_LOCAL_INCLUDES</source>
            <translation>Si la balise \c FORCE_LOCAL_INCLUDES est definie a \c YES, Doxygen listera les fichiers include avec des guillemets doubles dans la documentation plutot qu&#x27;avec des chevrons.</translation>
    </message>
<message>
        <source>INLINE_INFO</source>
            <translation>Si la balise \c INLINE_INFO est definie a \c YES, une balise [inline] est inseree dans la documentation pour les membres inline.</translation>
    </message>
<message>
        <source>SORT_MEMBER_DOCS</source>
            <translation>Si la balise \c SORT_MEMBER_DOCS est definie a \c YES, Doxygen triera la documentation (detaillee) des membres de fichier et de classe alphabetiquement par nom de membre. Si defini a \c NO, les membres apparaitront dans l&#x27;ordre de declaration.</translation>
    </message>
<message>
        <source>SORT_BRIEF_DOCS</source>
            <translation>Si la balise \c SORT_BRIEF_DOCS est definie a \c YES, Doxygen triera les descriptions breves des membres de fichier, namespace et classe alphabetiquement par nom de membre. Si defini a \c NO, les membres apparaitront dans l&#x27;ordre de declaration. Remarquez que cela influencera egalement l&#x27;ordre des classes dans la liste des classes.</translation>
    </message>
<message>
        <source>SORT_MEMBERS_CTORS_1ST</source>
            <translation>Si la balise \c SORT_MEMBERS_CTORS_1ST est definie a \c YES, Doxygen triera la documentation (breve et detaillee) des membres de classe de sorte que les constructeurs et destructeurs soient listes en premier. Si defini a \c NO, les constructeurs apparaitront dans les ordres respectifs definis par \ref cfg_sort_brief_docs &quot;SORT_BRIEF_DOCS&quot; et \ref cfg_sort_member_docs &quot;SORT_MEMBER_DOCS&quot;. \note Si \ref cfg_sort_brief_docs &quot;SORT_BRIEF_DOCS&quot; est defini a \c NO, cette option est ignoree pour le tri de la documentation breve des membres. \note Si \ref cfg_sort_member_docs &quot;SORT_MEMBER_DOCS&quot; est defini a \c NO, cette option est ignoree pour le tri de la documentation detaillee des membres.</translation>
    </message>
<message>
        <source>SORT_GROUP_NAMES</source>
            <translation>Si la balise \c SORT_GROUP_NAMES est definie a \c YES, Doxygen triera la hierarchie des noms de groupes par ordre alphabetique. Si defini a \c NO, les noms de groupes apparaitront dans leur ordre defini.</translation>
    </message>
<message>
...
<message>
        <source>STRICT_PROTO_MATCHING</source>
            <translation>Si l&#x27;option \c STRICT_PROTO_MATCHING est activee et que Doxygen echoue a faire une resolution de type correcte de tous les parametres d&#x27;une fonction, il rejettera une correspondance entre le prototype et l&#x27;implementation d&#x27;une fonction membre meme s&#x27;il n&#x27;y a qu&#x27;un seul candidat ou s&#x27;il est evident quel candidat choisir en faisant une simple correspondance de chaine. En desactivant \c STRICT_PROTO_MATCHING, Doxygen acceptera toujours une correspondance entre le prototype et l&#x27;implementation dans de tels cas.</translation>
    </message>
<message>
        <source>GENERATE_TODOLIST</source>
            <translation>La balise \c GENERATE_TODOLIST peut etre utilisee pour activer (\c YES) ou desactiver (\c NO) la liste des taches a faire. Cette liste est creee en mettant des commandes \ref cmdtodo &quot;\todo&quot; dans la documentation.</translation>
    </message>
<message>
...
<message>
        <source>REQ_TRACEABILITY_INFO</source>
            <translation>La balise \c REQ_TRACEABILITY_INFO controle si les informations de tracabilite sont affichees sur la page des exigences (pertinent uniquement lors de l&#x27;utilisation de blocs de commentaires \ref cmdrequirement &quot;\requirement&quot;). Le reglage \c NO desactivera completement les informations de tracabilite. Le reglage \c UNSATISFIED_ONLY affichera une liste des exigences qui manquent d&#x27;une relation satisfies (via la commande: \ref cmdsatisfies &quot;\satisfies&quot;). De meme, le reglage \c UNVERIFIED_ONLY affichera une liste des exigences qui manquent d&#x27;une relation verifies (via la commande: \ref cmdverifies &quot;\verifies&quot;). Definir la balise a \c YES (le defaut) affichera les deux listes si applicable.</translation>
    </message>
<message>
        <source>ENABLED_SECTIONS</source>
            <translation>La balise \c ENABLED_SECTIONS peut etre utilisee pour activer des sections de documentation conditionnelles, marquees par des blocs \ref cmdif &quot;\if&quot; \ &lt;section_label\&gt; ... \ref cmdendif &quot;\endif&quot; et \ref cmdcond &quot;\cond&quot; \ &lt;section_label\&gt; ... \ref cmdendcond &quot;\endcond&quot;.</translation>
    </message>
<message>
        <source>MAX_INITIALIZER_LINES</source>
            <translation>La balise \c MAX_INITIALIZER_LINES determine le nombre maximal de lignes que la valeur initiale d&#x27;une variable ou macro / definition peut avoir pour apparaitre dans la documentation. Si l&#x27;initialisateur se compose de plus de lignes que specifie ici, il sera cache. Utilisez une valeur de 0 pour cacher completement les initialisateurs. L&#x27;apparence de la valeur des variables individuelles et macros / definitions peut etre controlee en utilisant les commandes \ref cmdshowinitializer &quot;\showinitializer&quot; ou \ref cmdhideinitializer &quot;\hideinitializer&quot; dans la documentation independamment de ce reglage.</translation>
    </message>
<message>
        <source>SHOW_USED_FILES</source>
            <translation>Definissez la balise \c SHOW_USED_FILES a \c NO pour desactiver la liste des fichiers generes en bas de la documentation des classes et structures. Si defini a \c YES, la liste mentionnera les fichiers qui ont ete utilises pour generer la documentation.</translation>
    </message>
<message>
        <source>SHOW_FILES</source>
            <translation>Definissez la balise \c SHOW_FILES a \c NO pour desactiver la generation de la page Fichiers. Cela supprimera l&#x27;entree Fichiers de l&#x27;Index Rapide et de la Vue en Arborescence des Dossiers (si specifie).</translation>
    </message>
<message>
        <source>SHOW_NAMESPACES</source>
            <translation>Definissez la balise \c SHOW_NAMESPACES a \c NO pour desactiver la generation de la page Namespaces. Cela supprimera l&#x27;entree Namespaces de l&#x27;Index Rapide et de la Vue en Arborescence des Dossiers (si specifie).</translation>
    </message>
<message>
...
<message>
        <source>WARNINGS</source>
            <translation>La balise \c WARNINGS peut etre utilisee pour activer/desactiver les messages d&#x27;avertissement qui sont generes vers l&#x27;erreur standard (\c stderr) par Doxygen. Si \c WARNINGS est defini a \c YES, cela implique que les avertissements sont actives. &lt;br&gt; \b Conseil: Activez les avertissements pendant l&#x27;ecriture de la documentation.</translation>
    </message>
<message>
        <source>WARN_IF_UNDOCUMENTED</source>
            <translation>Si la balise \c WARN_IF_UNDOCUMENTED est definie a \c YES, Doxygen generera des avertissements pour les membres non documentes. Si \ref cfg_extract_all &quot;EXTRACT_ALL&quot; est defini a \c YES, ce drapeau sera automatiquement desactive.</translation>
    </message>
<message>
...
<message>
        <source>WARN_IF_INCOMPLETE_DOC</source>
            <translation>Si \c WARN_IF_INCOMPLETE_DOC est defini a \c YES, Doxygen avertira des documentations incompletes des parametres de fonction. Si defini a \c NO, Doxygen acceptera que certains parametres n&#x27;aient pas de documentation sans avertissement.</translation>
    </message>
<message>
        <source>WARN_NO_PARAMDOC</source>
            <translation>Cette option \c WARN_NO_PARAMDOC peut etre activee pour obtenir des avertissements pour les fonctions qui sont documentees mais n&#x27;ont pas de documentation pour leurs parametres ou valeur de retour. Si defini a \c NO, Doxygen avertira uniquement des erreurs de documentation de parametres, mais pas de l&#x27;absence de documentation. Si \ref cfg_extract_all &quot;EXTRACT_ALL&quot; est defini a \c YES, ce drapeau sera automatiquement desactive. Voir aussi \ref cfg_warn_if_incomplete_doc &quot;WARN_IF_INCOMPLETE_DOC&quot;</translation>
    </message>
<message>
        <source>WARN_IF_UNDOC_ENUM_VAL</source>
            <translation>Si l&#x27;option \c WARN_IF_UNDOC_ENUM_VAL est definie a \c YES, Doxygen avertira des valeurs d&#x27;enumeration non documentees. Si defini a \c NO, Doxygen acceptera les valeurs d&#x27;enumeration non documentees. Si \ref cfg_extract_all &quot;EXTRACT_ALL&quot; est defini a \c YES, ce drapeau sera automatiquement desactive.</translation>
    </message>
<message>
        <source>WARN_LAYOUT_FILE</source>
            <translation>Si l&#x27;option \c WARN_LAYOUT_FILE est definie a \c YES, Doxygen avertira des problemes trouves lors de l&#x27;analyse du fichier de mise en page defini par l&#x27;utilisateur, comme des elements manquants ou incorrects. Voir aussi \ref cfg_layout_file &quot;LAYOUT_FILE&quot; pour plus de details. Si defini a \c NO, les problemes avec le fichier de mise en page seront supprimes.</translation>
    </message>
<message>
        <source>WARN_AS_ERROR</source>
            <translation>Si la balise \c WARN_AS_ERROR est definie a \c YES, Doxygen s&#x27;arretera immediatement lorsqu&#x27;un avertissement est rencontre. Si la balise \c WARN_AS_ERROR est definie a \c FAIL_ON_WARNINGS, Doxygen continuera a s&#x27;executer comme si la balise \c WARN_AS_ERROR etait definie a \c NO, mais a la fin du processus Doxygen, Doxygen retournera un statut non nul. Si la balise \c WARN_AS_ERROR est definie a \c FAIL_ON_WARNINGS_PRINT, Doxygen se comportera comme \c FAIL_ON_WARNINGS mais dans le cas ou aucun \ref cfg_warn_logfile &quot;WARN_LOGFILE&quot; n&#x27;est defini, Doxygen n&#x27;ecrira pas les messages d&#x27;avertissement entre les autres messages mais les ecrira a la fin d&#x27;une execution, dans le cas ou un \ref cfg_warn_logfile &quot;WARN_LOGFILE&quot; est defini, les messages d&#x27;avertissement seront en plus d&#x27;etre dans le fichier defini egalement affiches a la fin d&#x27;une execution, sauf si le \ref cfg_warn_logfile &quot;WARN_LOGFILE&quot; est defini comme `-` c&#x27;est-a-dire la sortie standard (`stdout`) dans ce cas le comportement restera comme avec le reglage \c FAIL_ON_WARNINGS.</translation>
    </message>
<message>
...
<message>
        <source>WARN_LINE_FORMAT</source>
            <translation>Dans la partie `$text` de la commande \ref cfg_warn_format &quot;WARN_FORMAT&quot;, il est possible qu&#x27;une reference a un endroit plus specifique soit donnee. Pour faciliter le saut a cet endroit (en dehors de Doxygen), l&#x27;utilisateur peut definir une chaine de &quot;couper&quot; / &quot;coller&quot; personnalisee. Exemple: \verbatim WARN_LINE_FORMAT = &quot;&#x27;vi $file +$line&#x27;&quot; \endverbatim \sa \ref cfg_warn_format &quot;WARN_FORMAT&quot;</translation>
    </message>
<message>
        <source>WARN_LOGFILE</source>
            <translation>La balise \c WARN_LOGFILE peut etre utilisee pour specifier un fichier dans lequel les messages d&#x27;avertissement et d&#x27;erreur doivent etre ecrits. Si laissee vide, la sortie est ecrite vers l&#x27;erreur standard (`stderr`). Dans le cas ou le fichier specifie ne peut pas etre ouvert pour ecriture, les messages d&#x27;avertissement et d&#x27;erreur sont ecrits vers l&#x27;erreur standard. Lorsqu&#x27;un fichier `-` est specifie, les messages d&#x27;avertissement et d&#x27;erreur sont ecrits vers la sortie standard (`stdout`).</translation>
    </message>
<message>
        <source>INPUT</source>
...
<message>
        <source>INPUT_ENCODING</source>
            <translation>Cette balise peut etre utilisee pour specifier l&#x27;encodage des caracteres des fichiers sources que Doxygen analyse. En interne, Doxygen utilise l&#x27;encodage UTF-8. Doxygen utilise `libiconv` (ou l&#x27;`iconv` integre dans `libc`) pour le transcodage. Voir &lt;a href=&quot;https://www.gnu.org/software/libiconv/&quot;&gt;la documentation libiconv&lt;/a&gt; pour la liste des encodages possibles. \sa \ref cfg_input_file_encoding &quot;INPUT_FILE_ENCODING&quot;</translation>
    </message>
<message>
        <source>INPUT_FILE_ENCODING</source>
            <translation>Cette balise peut etre utilisee pour specifier l&#x27;encodage des caracteres des fichiers sources que Doxygen analyse. La balise \c INPUT_FILE_ENCODING peut etre utilisee pour specifier l&#x27;encodage des caracteres sur une base par modele de fichier. Doxygen comparera le nom du fichier avec chaque modele et appliquera l&#x27;encodage au lieu du \ref cfg_input_encoding &quot;INPUT_ENCODING&quot; par defaut s&#x27;il y a une correspondance. Les encodages de caracteres sont une liste de la forme: pattern=encoding (comme `*.php=ISO-8859-1`). \sa \ref cfg_input_encoding &quot;INPUT_ENCODING&quot; pour plus d&#x27;informations sur les encodages supportes.</translation>
    </message>
<message>
        <source>FILE_PATTERNS</source>
            <translation>Si la valeur de la balise \ref cfg_input &quot;INPUT&quot; contient des repertoires, vous pouvez utiliser la balise \c FILE_PATTERNS pour specifier un ou plusieurs modeles de caracteres generiques (comme `*.cpp` et `*.h`) pour filtrer les fichiers sources dans les repertoires. &lt;br&gt;Remarquez que pour les extensions personnalisees ou non directement supportees, vous devez egalement definir \ref cfg_extension_mapping &quot;EXTENSION_MAPPING&quot; pour l&#x27;extension sinon les fichiers ne sont pas lus par Doxygen. &lt;br&gt;Remarquez que la liste des modeles de fichiers coches par defaut peut differer de la liste des \ref default_file_extension_mapping &quot;correspondances d&#x27;extensions de fichiers par defaut&quot;. &lt;br&gt;Si laisse vide, les modeles suivants sont testes:</translation>
    </message>
<message>
        <source>RECURSIVE</source>
            <translation>La balise \c RECURSIVE peut etre utilisee pour specifier si les sous-repertoires doivent egalement etre recherches pour les fichiers d&#x27;entree.</translation>
    </message>
<message>
...
<message>
        <source>EXCLUDE_PATTERNS</source>
            <translation>Si la valeur de la balise \ref cfg_input &quot;INPUT&quot; contient des repertoires, vous pouvez utiliser la balise \c EXCLUDE_PATTERNS pour specifier un ou plusieurs modeles de caracteres generiques pour exclure certains fichiers de ces repertoires. &lt;br&gt;Remarquez que les caracteres generiques sont mis en correspondance avec le fichier avec le chemin absolu, donc pour exclure tous les repertoires de test par exemple utilisez le modele `*``/test/``*`</translation>
    </message>
<message>
...
<message>
        <source>EXAMPLE_PATTERNS</source>
            <translation>Si la valeur de la balise \ref cfg_example_path &quot;EXAMPLE_PATH&quot; contient des repertoires, vous pouvez utiliser la balise \c EXAMPLE_PATTERNS pour specifier un ou plusieurs modeles de caracteres generiques (comme `*.cpp` et `*.h`) pour filtrer les fichiers sources dans les repertoires. Si laisse vide, tous les fichiers sont inclus.</translation>
    </message>
<message>
        <source>EXAMPLE_RECURSIVE</source>
            <translation>Si la balise \c EXAMPLE_RECURSIVE est definie a \c YES, les sous-repertoires seront recherches pour les fichiers d&#x27;entree a utiliser avec les commandes \ref cmdinclude &quot;\include&quot; ou \ref cmddontinclude &quot;\dontinclude&quot; independamment de la valeur de la balise \ref cfg_recursive &quot;RECURSIVE&quot;.</translation>
    </message>
<message>
...
<message>
        <source>INPUT_FILTER</source>
            <translation>La balise \c INPUT_FILTER peut etre utilisee pour specifier un programme que Doxygen devrait invoquer pour filtrer chaque fichier d&#x27;entree. Doxygen invoquera le programme de filtre en executant (via &lt;code&gt;popen()&lt;/code&gt;) la commande: &lt;br&gt; &lt;code&gt;\&lt;filter\&gt; \&lt;input-file\&gt;&lt;/code&gt; &lt;br&gt; ou &lt;code&gt;\&lt;filter\&gt;&lt;/code&gt; est la valeur de la balise \c INPUT_FILTER, et &lt;code&gt;\&lt;input-file\&gt;&lt;/code&gt; est le nom d&#x27;un fichier d&#x27;entree. Doxygen utilisera ensuite la sortie que le programme de filtre ecrit sur la sortie standard. Si \ref cfg_filter_patterns &quot;FILTER_PATTERNS&quot; est specifie, cette balise sera ignoree. &lt;br&gt;Remarquez que le filtre ne doit pas ajouter ou supprimer de lignes; il est applique avant que le code ne soit scanne, mais pas lorsque le code de sortie est genere. Si des lignes sont ajoutees ou supprimees, les ancres ne seront pas placees correctement. &lt;br&gt;Remarquez que Doxygen utilisera les donnees traitees et ecrites sur la sortie standard pour un traitement ulterieur, donc rien d&#x27;autre, comme des instructions de debug ou des commandes utilisees (donc dans le cas d&#x27;un fichier batch Windows utilisez toujours `@echo OFF`), ne doit etre ecrit sur la sortie standard. &lt;br&gt;Remarquez que pour les extensions personnalisees ou non directement supportees, vous devez egalement definir \ref cfg_extension_mapping &quot;EXTENSION_MAPPING&quot; pour l&#x27;extension sinon les fichiers ne sont pas correctement traites par Doxygen.&lt;br&gt;</translation>
    </message>
<message>
        <source>FILTER_PATTERNS</source>
            <translation>La balise \c FILTER_PATTERNS peut etre utilisee pour specifier des filtres sur une base par modele de fichier. Doxygen comparera le nom du fichier avec chaque modele et appliquera le filtre s&#x27;il y a une correspondance. Les filtres sont une liste de la forme: pattern=filter (comme `*.cpp=my_cpp_filter`). Voir \ref cfg_input_filter &quot;INPUT_FILTER&quot; pour plus d&#x27;informations sur l&#x27;utilisation des filtres. Si la balise \c FILTER_PATTERNS est vide ou si aucun des modeles ne correspond au nom du fichier, \ref cfg_input_filter &quot;INPUT_FILTER&quot; est applique. &lt;br&gt;Remarquez que pour les extensions personnalisees ou non directement supportees, vous devez egalement definir \ref cfg_extension_mapping &quot;EXTENSION_MAPPING&quot; pour l&#x27;extension sinon les fichiers ne sont pas correctement traites par Doxygen.&lt;br&gt;</translation>
    </message>
<message>
...
<message>
        <source>FILTER_SOURCE_PATTERNS</source>
            <translation>La balise \c FILTER_SOURCE_PATTERNS peut etre utilisee pour specifier des filtres sources par modele de fichier. Un modele remplacera le reglage pour \ref cfg_filter_patterns &quot;FILTER_PATTERN&quot; (s&#x27;il y en a) et il est egalement possible de desactiver le filtrage source pour un modele specifique en utilisant `*.ext=` (donc sans nommer de filtre).</translation>
    </message>
<message>
...
<message>
        <source>FORTRAN_COMMENT_AFTER</source>
            <translation>La norme Fortran specifie que pour le code Fortran a format fixe, tous les caracteres a partir de la position 72 sont consideres comme des commentaires. Une extension courante est d&#x27;autoriser des lignes plus longues avant que le commentaire automatique ne commence. Le reglage \c FORTRAN_COMMENT_AFTER permettra egalement que des lignes plus longues puissent etre traitees avant que le commentaire automatique ne commence.</translation>
    </message>
<message>
