...
Alternatively, you can use #'s at the start of a line to make a
...
Note that doxygen will also produce the links without the angle
brackets.
...
Special care has to be taken when using *'s in a comment block to
